...
export function MobileLibrarySheet({ onClose, onSelectArtefact }: MobileLibrarySheetProps) {
                ...
                <div className="px-4 py-2 border-b flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {language === 'th' ? 'เลือก Artefact เพื่อดูรายละเอียด' : 'Select Artefact to view details'}
                        </p>
                    </div>
                    <button
                        onClick={onClose}
                            ...
                            return (
                                <div key={type} className="space-y-2">
                                    <h4 className="text-xs font-bold uppercase text-muted-foreground flex items-center gap-2">
                                        <span className={cn("w-2 h-2 rounded-full", graphTypeColors[type])}></span>
                                        ...
                                        {typeArtefacts.map(artefact => (
                                            ...
                                            >
                                                <div className="flex items-center gap-2 mb-1">
                                                    <div className={cn("p-1 rounded", graphTypeColors[type])}>
