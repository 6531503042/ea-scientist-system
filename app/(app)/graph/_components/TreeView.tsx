    ...
    <div className="h-full flex flex-col bg-card rounded-lg overflow-hidden border border-border shadow-sm">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {totalNodes} nodes • Department of Science Service
            </p>
          </div>
      ...
      <div className="p-3 border-t border-border bg-muted/20">
        <div className="flex items-center gap-2 overflow-x-auto pb-1">
          ...
          {Object.entries(treeNodeIcons)
            .slice(0, 6)
            .map(([type, icon]) => (
              <div
                key={type}
                className="flex items-center gap-1 flex-shrink-0 bg-background border border-border rounded px-1.5 py-0.5"
              >
