...
export function AuditLogTable({
  ...
  const handleExport = () => {
    const url = new URL(resolveApiUrl("/api/v1/audit-logs/export"));
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-muted/30">
                  ...
                  <th className="text-center px-5 py-4 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                    ระดับ
                  </th>
                </tr>
              </thead>
