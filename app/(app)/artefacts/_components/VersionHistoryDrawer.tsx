...
import { useArtefactVersions } from '@/hooks/useArtefactVersions';
...
export function VersionHistoryDrawer({
  ...
  const vh = useLocale('versionHistory');
  const { versions, loading } = useArtefactVersions(artefactId, isOpen);
                          ...
                          {version.previousVersion && (
                            <div className="mt-3 pt-3 border-t border-border">
                              <span className="text-xs text-muted-foreground flex items-center gap-1">
                                ...
                                {vh.updatedFrom} v{version.previousVersion}
                              </span>
                            </div>
                          )}
                        </div>
