  ...
  return (
    ...
    >
        ...
        <div className={cn(
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium truncate">Enterprise Architect</p>
              <p className="text-xs text-sidebar-foreground/60 truncate">architect@dss.go.th</p>
            </div>
          )}
        </div>
      </div>
      ...
      <button
        ...
        className="absolute -right-3 top-20 flex items-center justify-center w-6 h-6 rounded-full bg-card border border-border shadow-sm hover:bg-accent hover:text-accent-foreground transition-colors"
      >
        {collapsed ? (
